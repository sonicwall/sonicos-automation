...
## [SNWLID-2024-0015](https://psirt.global.sonicwall.com/vuln-detail/SNWLID-2024-0015)
...
1. Run the script against a single target firewall.
   - `python snwlid-2024-0015.py 192.168.168.168`
...
2. Run the script against multiple target firewalls.
   - `python snwlid-2024-0015.py firewalls.csv`
   ...
   - Anything newer than 7.0.1-5035 is not vulnerable and would not prompt for an upgrade.
     - SonicOS 7.1.x is not vulnerable to CVE-2024-40766 / SNWLID-2024-0015.
     - Additionally, SonicOS 7.1.x includes a great automatic upgrade feature.
