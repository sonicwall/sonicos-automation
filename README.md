...
| Essential Credential Reset/Remediation Playbook Script<br>Automates:<br> - Bulk password resets<br> - Setting randomized temporary passwords<br> - Bulk TOTP resets<br> - Remediation checks with prioritized guidance with resources for manual remediation. | [remediation-app.py](remediation-app.py)<br>[reset_credentials.py](reset_credentials.py) | [README-reset-credentials.md](README-reset-credentials.md) |
